...
"""autogenerated by genpy from sbg_driver/SbgEkfEuler.msg. Do not edit."""
import sys
...
class SbgEkfEuler(genpy.Message):
  _md5sum = "4862d08d71471abacf02c798eaa2e18f"
  _type = "sbg_driver/SbgEkfEuler"
...
bool odo_used
"""
  __slots__ = ['header','time_stamp','angle','accuracy','status']
  _slot_types = ['std_msgs/Header','uint32','geometry_msgs/Vector3','geometry_msgs/Vector3','sbg_driver/SbgEkfStatus']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,time_stamp,angle,accuracy,status
    ...
    """
    if args or kwds:
      super(SbgEkfEuler, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_I6d16B().pack(_x.time_stamp, _x.angle.x, _x.angle.y, _x.angle.z, _x.accuracy.x, _x.accuracy.y, _x.accuracy.z, _x.status.solution_mode, _x.status.attitude_valid, _x.status.heading_valid, _x.status.velocity_valid, _x.status.position_valid, _x.status.vert_ref_used, _x.status.mag_ref_used, _x.status.gps1_vel_used, _x.status.gps1_pos_used, _x.status.gps1_course_used, _x.status.gps1_hdt_used, _x.status.gps2_vel_used, _x.status.gps2_pos_used, _x.status.gps2_course_used, _x.status.gps2_hdt_used, _x.status.odo_used))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_stamp, _x.angle.x, _x.angle.y, _x.angle.z, _x.accuracy.x, _x.accuracy.y, _x.accuracy.z, _x.status.solution_mode, _x.status.attitude_valid, _x.status.heading_valid, _x.status.velocity_valid, _x.status.position_valid, _x.status.vert_ref_used, _x.status.mag_ref_used, _x.status.gps1_vel_used, _x.status.gps1_pos_used, _x.status.gps1_course_used, _x.status.gps1_hdt_used, _x.status.gps2_vel_used, _x.status.gps2_pos_used, _x.status.gps2_course_used, _x.status.gps2_hdt_used, _x.status.odo_used,) = _get_struct_I6d16B().unpack(str[start:end])
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_I6d16B = None
def _get_struct_I6d16B():
    global _struct_I6d16B
    if _struct_I6d16B is None:
        _struct_I6d16B = struct.Struct("<I6d16B")
    return _struct_I6d16B
