...
def salinite(cond,T):
    """
    Formule de la salinité en fonction de la conductivité et de la température.
    Plus d'informations sur: http://www.kikiwi.fr/uploads/data/Mesures/Conductimetre/conductimetre_v1.2.pdf
    ...
    """
    return((0.72*cond-3.06)*(1+0.02*(T-25)))
...
#            print(temp_frame)
            ...
            cond = temp_frame[48:54].decode("utf-8") # extraction de T
#            sal = 35
